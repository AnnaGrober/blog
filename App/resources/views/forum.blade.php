	        ...
	        <div class="row media text-muted pt-3">
                ...
                @isset (Auth::user()->id )
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2 resp" >
                        <a href="del_subject_for_forum/{{$Subject->id}}"  class="btn secondary" id="delete_subj" style="height: 30px; margin-bottom:10px; padding-top: 4px; color:black; border: none; " role="button">Удалить</a>
